<template>
  <div class="max-w-2xl space-y-6">
    ...
    <h1 class="text-lg font-semibold text-gray-900 dark:text-gray-100">New Restaurant Order</h1>
    ...
    <Card title="Items">
      <template #actions>
        <Button variant="outline" @click="addLine">+ Add Line</Button>
      </template>
      <div class="space-y-2">
        <div v-for="(line, i) in lines" :key="i" class="grid grid-cols-12 items-center gap-2">
          <input v-model="line.item" type="text" placeholder="Item" class="input-field col-span-6" />
